...
####################################################################
## Written by fanese-myk, this is my CSAPP ArchLab homework, for adding iaddq
...
word f_pc = [
	...
	M_icode == IJXX && !M_Cnd : M_valA; # here valA is actually valP
	# Completion of RET instruction
	W_icode == IRET : W_valM; #W means it is after Memory reading, so valM is read from memory
	# Default: Use predicted value of PC
	1 : F_predPC; #This is true
];
...
# Does fetched instruction require a regid byte? YES!~
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ };

# Does fetched instruction require a constant word? YES!~
bool need_valC =
...
## What register should be used as the A source? NONE FOR IIADDQ
word d_srcA = [
...
## What register should be used as the B source? rB!
word d_srcB = [
...
## What register should be used as the E destination? rB!
word d_dstE = [
...
word d_valA = [
	D_icode in { ICALL, IJXX } : D_valP; # Use incremented PC(Here, valA and valP combined)
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ } : E_valC; #IIADDQ's input A is valC
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ, IIADDQ } : E_valB; #IIADDQ 's input B is valB
...
## Should the condition codes be updated? OPQ and iaddq
...
bool F_bubble = 0; # can not add a bubble to fetch
bool F_stall =
